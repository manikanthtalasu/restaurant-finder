<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/index.php">Restaurant Finder</a>
			</div>
			<div id="navbar" class="navbar-collapse collapse ">
				<ul class="nav navbar-nav  navbar-right">
					...
					else
					{
						...
						{
							echo '<li>
							<a class="btn btn-primary btn-custom" href="/owner-track-order.php" ><i class="fa fa-flash"></i> Orders</a>
							</li>';
							echo '<li>
						...
						{
							echo '<li>
							<a class="btn btn-primary btn-custom" href="/user-track-order.php" ><i class="fa fa-flash"></i> History</a>
							</li>';
						}
						if($session->get_session_data('user_type') == 'admin')
						{
							echo '<li>
							<a class="btn btn-primary btn-custom" href="/admin-dashboard.php" ><i class="fa fa-flash"></i> Dashboard</a>
							</li>';
						}
						echo '<li>
						<a class="btn btn-danger btn-custom" href="./api/users/logout.php" ><i class="fa fa-sign-out"></i> Logout</a>
						</li>';
