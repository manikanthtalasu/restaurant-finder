			...
			<table class="table table-striped table-hover"> 
				...
				<tbody> 
					...
					foreach ($data as $value) {
						...
						<td><b>Restaurant:</b> ';
						echo $value['name'].'<br>
						<b>Customer Name: </b>'.$value['first_name'].' '.$value['last_name'].'<br>
						...
						switch (intval($value['orderStatus'])) {
							...
							case 6: echo '<span class="label label-danger">Delivered</span>';
								break;
								default:echo '<span class="label label-danger">Delivered</span>';
								break;
						}
						echo ' <a href="next_step.php?order-id='.$value['orderId'].'" class="label label-success"><i class="fa fa-fast-forward"></i> Next Step</a></td> 
					</tr> ';
					}
